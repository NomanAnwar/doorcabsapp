...
import 'package:doorcab/feautures/shared/screens/review_screen.dart';
        ...
        child: Obx(() {
          ...
          return Stack(
            children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      controller.getFormattedAccountStatus(data.accountStatus),
                                      style: TextStyle(
                                        fontSize: sw(16),
                                        fontWeight: FontWeight.w500,
                                        color: Colors.black,
                                    ...
                                    SvgPicture.asset(
                                      ...
                                      width: sw(20),
                                      height: sh(20),
                                      color: data.accountStatus == 'approved' ? Colors.green : Colors.orange,
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  Get.to(ReviewScreen(), arguments: {
                                    'rating': performanceController.performance.value.averageRating,
                                    'reviewCount': performanceController.performance.value.totalRatings,
                                  });
                                },
                                child: Obx(() {
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            SizedBox(width: sw(6)),
                                            Text(
                                              "${data.averageRating.toStringAsFixed(1)} (${data.totalRatings} Reviews)",
                                              style: TextStyle(
                                                fontSize: sw(16),
                                                fontWeight: FontWeight.w500,
                                                color: Colors.black,
              ...
              /// Loader Overlay (OTP Screen Pattern)
              if (loading)
                Container(
                  height: screenHeight,
                  width: screenWidth,

...
class RideRequestDetailScreen extends StatelessWidget {
          ...
          Positioned(
            ...
            child: Obx(() {
              ...
              return GoogleMap(
                ...
                markers: c.markers,
                polylines:
                c.routePolyline.value != null ? {c.routePolyline.value!} : {},
              );
            }),
          ),
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    top: sh(20),
                    left: sw(185),
                    child: const Icon(Icons.star, size: 14, color: Color(0xFFFFC300)),
                  ),
                  Positioned(
                    top: sh(20),
                    left: sw(210),
            ...
            child: Row(
              children: [
                ElevatedButton.icon(
                  ...
                  label: Obx(() => Text("PKR ${c.fare.value}",
  ...
  Widget _fareChip(String amount, double Function(double) sw,
      RideRequestDetailController c,
      {bool selected = false}) {
    return Obx(() {
      final isSelected = selected || c.fare.value.toString() == amount;
      return InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? const Color(0xFF003566) : const Color(0xFF595959),
            borderRadius: BorderRadius.circular(10),
          ),
          child: Text(
            "PKR $amount",

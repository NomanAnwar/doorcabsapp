            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _drawerItem(Icons.account_balance_wallet, 'Rate', () { Get.toNamed('/rate'); }, sw),
                  _drawerItem(Icons.account_balance_wallet, 'chat', () { Get.toNamed('/chat'); }, sw),
                ],
              ),
            ),
            Padding(
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _drawerItem(Icons.support, 'Rate', () {Get.toNamed('/rate');}, sw),
                  _drawerItem(Icons.support, 'chat', () {Get.toNamed('/chat');}, sw),
                ],
              ),
            ),
